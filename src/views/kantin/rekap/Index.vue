            ...
            <div class="w-full flex flex-column bg-white p-3 border-round shadow-2 gap-3">
                <div class="flex flex-column md:flex-row justify-content-between align-items-center">
                    ...
                    <div class="flex justify-content-between gap-2">
                        ...
                        <button @click="active = 1" :class="`${active == 1 ? 'bg-white text-teal-500' : 'bg-teal-500 text-white hover:bg-teal-700 hover:text-white'} cursor-pointer transition-all transition-ease-in-out transition-duration-400 shadow-2 border-round-sm px-3 py-2 border-none flex gap-2 align-items-center uppercase font-medium`"><strong class="px-1 bg-white text-teal-500 border-circle">1</strong>kehadiran user</button>
                        <button @click="active = 2" :class="`${active == 2 ? 'bg-white text-teal-500' : 'bg-teal-500 text-white hover:bg-teal-700 hover:text-white'} cursor-pointer transition-all transition-ease-in-out transition-duration-400 shadow-2 border-round-sm px-3 py-2 border-none flex gap-2 align-items-center uppercase font-medium`"><strong class="px-1 bg-white text-teal-500 border-circle">2</strong>kehadiran visitor</button>
                    </div>
                </div>
