...
<template>
    ...
    <div class="flex align-items-center fixed bottom-0 w-full">
        <div class="w-full py-2 w-full bg-bluegray-400">
            ...
            <marquee behavior="" direction="left" class="font-medium text-white" style="font-family: Times New Roman, Times, serif;"><span class='font-bold text-gray-300 uppercase'>rekan</span> v2.0 - 2022 &copy; PT Industri Nabati Lestari <span class="ml-2 text-yellow-200">(Aplikasi Update per <strong>03 Maret 2024</strong>)</span></marquee>
        </div>
        <div class="w-3 flex">
